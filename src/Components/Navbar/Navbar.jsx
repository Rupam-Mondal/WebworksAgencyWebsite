...
function Navbar() {
    ...
    return (
        <header className="w-full py-1 flex items-center justify-between px-6 sticky top-0 z-50 bg-background/60 backdrop-blur">
            {/* Logo Section */}
            ...
            <nav className={`md:flex items-center space-x-6 ${isOpen ? "block" : "hidden"} absolute md:relative top-full left-0 w-full md:w-auto bg-background/90 md:bg-transparent backdrop-blur-md md:backdrop-blur-none p-5 md:p-0`}>
                <ul className="flex flex-col md:flex-row md:space-x-4">
                    ...
                    <li className="list-none">
                        <button
                            className="group inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-md font-medium transition-colors hover:bg-red-100 hover:text-[#FF1C46] focus:bg-red-100 focus:text-[#FF1C46] focus:outline-none"
                ...
                <div className="mt-4 md:mt-0">
                    <a href="/signup" className="flex items-center gap-2 justify-center bg-[#FF1C46] text-white rounded-md px-4 py-2 text-sm font-semibold transition-colors">
